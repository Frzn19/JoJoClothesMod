...
public class DioClothesArmor extends ItemArmor implements IHasModel {

    public DioClothesArmor(String name, CreativeTabs tab, ArmorMaterial material, EntityEquipmentSlot equipmentSlot) {
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
        ...
        if(itemStack != ItemStack.EMPTY){
            if(itemStack.getItem() instanceof DioClothesArmor){
               DIOClothes model = new DIOClothes(0.2f);
